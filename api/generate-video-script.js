...
export default async function handler(req, res) {
  ...
  try {
    // Gemini free-tier a veces devuelve 503 "high demand" de forma
    // intermitente (conocido y documentado del lado de Google). Reintentamos
    // hasta 2 veces con backoff creciente antes de rendirnos — mismo patrón
    // que generate-content.js, pero con un intento extra porque este endpoint
    // ha mostrado rachas de 503 consecutivos.
